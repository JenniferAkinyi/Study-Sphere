...
const StreakCard = () => {
  ...
  let trend = "flat"
  if(userData?.previousStreak != null){
    if(userData.currentStreak > userData.previousStreak){
      trend = 'up'
    } else if(userData.currentStreak < userData.previousStreak){
      trend = 'down'
    }
  }
  return (
    <div className="p-3 bg-white border border-gray-200 shadow-sm rounded-xl lg:w-64">
      ...
      <h1 className="text-2xl font-extrabold">
        <span>{userData?.currentStreak ?? 0} </span>Days
      </h1>
